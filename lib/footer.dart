      ...
      children: [
        Container(
              ...
              children: [
                ...
                child: Text('BIRLA PUBLIC SCHOOL',) ,),
                Container(
                  alignment: Alignment.centerLeft ,
                  child: Row(
                    children: [
                      Icon(Icons.card_giftcard_rounded),
                      Text('Vidya Niketan Birla Public School, Pilani-333031'),
                    ],
                  ),
                ),
                Container(alignment: Alignment.centerLeft ,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.email),
                      Text('addmission@thebpsschool.org',style: TextStyle(color: Colors.green),),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.email),
                      Text('info@bpspilani.edu.in',style: TextStyle(color: Colors.green),),
                    ],
                  ),
                ),
                SizedBox(height: 30,),
            ...
            Column(children: [
              ...
              color: Colors.black,
              child: Center(
                child: Text('Designed And Maintained By: The Department Of ITC - Birla Public School - Pilani',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
              ),
            ),
